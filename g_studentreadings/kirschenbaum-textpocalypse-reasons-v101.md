...
Kirschenbaum extends Ong's [[@ong2012writi]] writing-as-technology insight into the digital realm. Where Ong focused on oral/literate transitions, Kirschenbaum examines print/digital transitions and the instability this creates. His work connects to **material hermeneutics** in composition studies—the idea that textual meaning is inseparable from material form (McGann, Hayles [[@hayles2004print]]).
...
- **Technical vocabulary**: Kirschenbaum uses terms (ASCII, Unicode, blockchain) that may be unfamiliar
- **Apocalyptic tone**: "Textpocalypse" framing could feel alarmist or depressing
- **Relevance question**: Students may wonder why a composition course cares about file formats
...
- [ ] Do students demonstrate awareness that file organization choices have consequences?
- [ ] In dev logs, do students reflect on tool choices (not just writing content)?
- [ ] Do students adopt course recommendations (consistent naming, organized folders) voluntarily or grudgingly?
- [ ] In Process Archaeology, can students articulate how file management evolved and why it mattered?
