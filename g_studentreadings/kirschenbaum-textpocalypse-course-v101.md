...
Kirschenbaum argues that we're living through a moment of profound instability in textual media. Digital text feels permanent (never degrades like paper) yet is radically fragile (depends on software, hardware, formats that constantly change). He examines how different storage media and file formats shape what writing can be and do, from ASCII's limitations to Word's invisibility of formatting codes to blockchain's distributed permanence. The essay makes visible the infrastructure of digital writing—the stuff we usually ignore until something breaks.
