...
Bush proposes the "memex"—a desk-sized machine where individuals build personal libraries of microfilmed documents connected by "trails" of associative links. Users could follow these trails (like clicking hyperlinks before hyperlinks existed), add new connections, and share trails with others. Bush argues that human thinking is associative (one idea suggests another) but that information storage is linear (books, filing cabinets). His vision: technology that matches how minds actually work—building knowledge through connection rather than hierarchical classification.
