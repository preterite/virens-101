...
depends-on: []
affects: [constraint-vocabulary, design-thinking]
uses-defs: []
last-sync-check: 
attention-flag: ""
---
...
- **Iterative resolution**: Addressing one misfit may create others (side effects). Design is iterative: resolve misfits, check for new misfits, iterate. Parallels Schön's reflection-in-action and agile development.
...
Students read Alexander's Chapter 2 (~20-25 pages) during Week 7, at the end of Movement 2. The guiding questions ask them to:

1. Identify specific misfits in their recent writing (diagnostic application)
2. Map constraint relationships (understanding interconnection)
3. Recognize context-dependence of form (fit framework)

These questions operationalize Alexander's concepts by applying them to students' ongoing work. Rather than learning architecture theory, students use Alexander as analytical tool for their writing challenges.
...
Alexander's framework recurs throughout the semester:

- **Movement 2**: Constraint Audit assignment (end of M2) explicitly asks students to identify and analyze constraints—operationalizing Alexander's approach
- **Movement 3**: Corpus management requires understanding how organizational constraints (folder structure, naming conventions, tags) enable or impede retrieval
- **Movement 4**: Portfolio assembly involves deliberate constraint management: fitting accumulated material (form) to portfolio requirements (context)

Process Archaeology asks students to document how their understanding of constraints evolved—exactly parallel to Alexander's iterative misfit resolution.
...
- **Reframes constraints**: From obstacles to information about fit requirements
- **Strategic revision**: Provides method for identifying and resolving problems systematically
- **Interconnected thinking**: Reveals how changes cascade through constraint networks

### Potential Challenges

- **Architecture context**: Examples from building design may feel distant from writing
- **Abstract concepts**: Fit, misfit, constraint decomposition require conceptual translation
- **Demanding read**: Alexander writes for design professionals; density and length challenging
...
- [ ] Do students use fit/misfit vocabulary in peer review, dev logs, and reflections?
- [ ] Can students identify specific constraint relationships (not just list constraints)?
- [ ] Do students demonstrate understanding that "good writing" is context-dependent (fit-based)?
- [ ] In Process Archaeology, do students reflect on evolving constraint understanding?

### Revision Notes

If architecture context creates barriers: consider supplementing with writing-specific examples of constraint management before reading Alexander, or excerpting most relevant sections on misfits and constraint relationships.

If concepts feel too abstract: develop Week 7 activity where students collaboratively identify misfits in sample writing before reading Alexander to recognize they already do this analysis intuitively.

If length is prohibitive: could assign Chapter 2 only (shortest, most accessible chapter) or excerpt key sections on misfits (pages 15-25 approximately).
...
- **Course Content**: [[alexander-goodness-fit-course-v101]]
- **Course Principles**: [[04b_operationalized_principles#Constraint sequencing]]
- **Vocabulary**: [[vocab-constraint]], [[vocab-fit]]
- **Related Assignment**: [[constraint-audit-course-v101]] (end of Movement 2)
