...
Bush's concept of **trails** (shareable sequences through information space) parallels the course's Process Archaeology: documenting how you navigated your corpus enables others to learn from your path. This connects to **transfer pedagogy**—making processes explicit enables adaptation to new contexts.

### Systems/Design Thinking

Bush writes at intersection of information science, cognitive psychology, and systems design:
...
- **Augmenting human intellect**: Bush's vision influenced Douglas Engelbart's "augmentation" framework—technology should extend human cognitive capabilities, not replace them. This parallels the course's approach: tools and systems augment writing process, not automate it.
...
- **Historical perspective**: Shows current challenges have deep roots; validates course innovations as part of long tradition
- **Conceptual framework**: Associative/linear tension explains portfolio assembly difficulty
- **Inspiration**: Bush's vision demonstrates ambitious thinking about how writing might work differently

### Potential Challenges

- **Dated technology**: Microfilm and mechanical desks feel archaic; may reduce engagement
- **Abstract vision**: Bush describes imagined technology, not actual practice
- **Late-semester timing**: Week 13 introduces historical reading when students focused on finishing
...
- Directly influenced by Bush; developed practical systems for augmentation
