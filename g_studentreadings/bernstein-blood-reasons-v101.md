...
- **Process archaeology**: Bernstein's emphasis on preserving cutting room floor material anticipates the course's Process Archaeology assignment. In software, this is version control history; in design, it's design journals. All make process visible for analysis.
...
- **Reframes struggle**: Revision difficulty becomes evidence of meaning-making, not inadequacy
- **Non-pedagogical voice**: Bernstein writes as practitioner, not teacher; may reach students differently
- **Concrete metaphor**: "Blood on the cutting room floor" gives visceral language for revision's emotional labor

### Potential Challenges

- **Poetry context**: Students may resist insights from poetry as irrelevant to their writing
- **Dense prose**: Bernstein writes for literary audience; some passages are conceptually demanding
- **Counterintuitive claim**: "Failed" experiments are valuable contradicts students' prior schooling
