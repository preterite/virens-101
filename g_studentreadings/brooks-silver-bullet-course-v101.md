...
3. **Focusing improvement efforts**: If you can distinguish essential from accidental complexity, you can focus on reducing accidental complexity (better organization, clearer systems) rather than expecting to eliminate essential complexity (the hard thinking). Looking at your writing process, what improvements might reduce accidental complexity (file management, retrieval systems, documentation) so you can focus energy on essential complexity (the intellectual work)?

---

## Related Notes

- **Justification**: [[brooks-silver-bullet-reasons-v101]]
- **Related Reading**: [[salvatori-conversations-texts-course-v101]] (difficulty as diagnostic)
