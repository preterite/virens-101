...
**Kenneth Bruffee's [[@bruffee1984collb]] collaborative learning theory** provides the foundational rationale for peer review in composition. In "Collaborative Learning and the 'Conversation of Mankind'" (1984), Bruffee argues that knowledge-making is fundamentally social—we learn to write by participating in communities of writers who share conventions, expectations, and values. Peer review operationalizes this theory: students don't just write for an instructor's evaluation; they write for peers who represent the academic community they're joining.
