...
You've completed Movement 1 (Surfacing), where you've been discovering your writing processes and building your initial [[vocab-corpus|corpus]] of [[vocab-fragment|fragments]]. Before entering Movement 2 (Naming), take time to identify what you've learned about yourself as a writer and what patterns have emerged in your early work.

This brief reflection helps you:
- Recognize surprises and discoveries from your first three weeks
- Identify early patterns before they become invisible habits
- Set intentions for approaching M2's naming and constraint work
- Practice evidence-based reflection skills you'll use all semester

**Due**: End of Week 3 (before entering M2)
...
Answer each of these four questions. Use specific evidence from your [[vocab-dev-log|development logs]], fragments, or [[weekly-accumulation-check-in-course-v101|accumulation check-ins]]. Consult the [[evidence-based-reflection-guide-course-v101|evidence-based reflection guide]] for help mining evidence and identifying patterns.

### 1. Surprises and Discoveries

**What surprised you most about your early fragments or writing process in Movement 1?**

This could be:
- Something about when/where/how you write best
- A discovery about your thinking process
- An unexpected challenge or ease with fragment writing
- A realization about your habits or patterns
...
**What patterns emerged in your first 8-12 fragments?**

Look for patterns in:
- Topics or themes you gravitate toward
- Types of claims you make (personal experience? Analysis? Argument?)
- How you use evidence or examples
- Fragment length or structure
...
**Looking at your dev logs from Weeks 1-3, what's one challenge you encountered repeatedly?**

Don't just name the challenge—describe it specifically:
- When does it appear?
...
**As you enter Movement 2 (Naming), what from M1 do you want to continue or change?**

Identify:
- One practice or approach to continue (what's working?)
...
After answering the four prompts, write one paragraph (150-250 words) in **first person** that synthesizes your M1 experience and transition to M2. 

This paragraph should:
- Draw connections across your answers to the four prompts
...
- **Justification**: [[M1-to-M2-transition-reflection-reasons-v101]]
- **How to Reflect**: [[evidence-based-reflection-guide-course-v101]]
- **Evidence Sources**: [[development-log-entries-course-v101]], [[weekly-accumulation-check-in-course-v101]], [[vocab-corpus]]
- **Movement Context**: [[M1-surfacing-overview-course-v101]], [[M2-naming-overview-course-v101]]
- **Next Checkpoint**: [[M2-to-M3-transition-reflection-course-v101]]
