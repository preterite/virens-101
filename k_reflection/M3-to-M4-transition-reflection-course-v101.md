...
## Context: Why Reflect Now?

You've completed Movement 3 (Operating at Scale), where you've managed your growing [[vocab-corpus|corpus]], worked with connections across multiple fragments, and developed practices for handling substantial accumulated material. You likely have 35-40 fragments now—approaching your semester target of ![[_def-fragment-target-total]].

Before entering Movement 4 (Synthesis), this reflection helps you:
- Recognize how working at scale changed your writing practice
- Identify surprising connections that emerged across fragments
- Assess your growth from beginning to late semester
- Prepare for synthesis work that transforms fragments into portfolio

This is your final movement transition before the [[portfolio-cover-letter-prompt-course-v101|portfolio cover letter]], which will ask you to synthesize across the entire semester. Think of this reflection as preparation for that comprehensive synthesis.

**Due**: End of Week 11 or early Week 12 (before entering M4)

**Graded**: Yes, weighted slightly more than weekly accumulation check-ins

---

## Structured Prompts

Answer each of these four questions. Use specific evidence from your [[vocab-dev-log|development logs]], corpus, or [[vocab-system-map|system maps]]. Consult the [[evidence-based-reflection-guide-course-v101|evidence-based reflection guide]] for help with evidence and pattern identification.

### 1. Scale Impact

**How did working with more fragments (20-40) change your writing practice?**

M3 emphasized managing substantial corpus. Consider:
- Did having more material make writing easier or harder? In what ways?
- How did you navigate or organize your accumulated fragments?
- What strategies emerged for finding connections across multiple pieces?
- Did scale change your relationship to individual fragments?
...
**What connections between fragments surprised you in M3?**

M3's scale work reveals patterns across your thinking. What did you discover?
- Did fragments connect in unexpected ways?
- Did your corpus reveal themes you hadn't planned?
...
**Compare your M3 work to M1-M2: what's improved and what still challenges you?**

Look across the full semester. Use evidence:
- Corpus statistics (early vs. late production rates, revision patterns)
- Dev log themes (do early struggles persist or change?)
- Fragment quality (compare M1 vs. M3 fragments)
- Process evolution (system maps, workflow changes)
...
### 4. Synthesis Anticipation

**As you prepare for synthesis in M4, what from your corpus excites or worries you?**

M4 will ask you to transform fragments into polished, connected portfolio pieces. Consider:
- What material are you most excited to develop?
- What challenges does synthesis present?
...
M3 preparation: The organizational systems I developed (tagging, color-coding, connection tracking) give me tools for synthesis. My Week 10 system map shows clear categories and relationships, which provides synthesis roadmap. M3 taught me to see fragments as material to shape, not as fixed products—that flexibility will help M4 synthesis work."

---

## Synthesis Paragraph

After answering the four prompts, write one paragraph (150-250 words) in **first person** that synthesizes your M3 experience and preparation for M4 synthesis.

This paragraph should:
- Connect insights from your four prompt responses
...
- **Justification**: [[M3-to-M4-transition-reflection-reasons-v101]]
- **How to Reflect**: [[evidence-based-reflection-guide-course-v101]]
- **Evidence Sources**: [[development-log-entries-course-v101]], [[vocab-corpus]], [[vocab-system-map]]
- **Movement Context**: [[M3-scale-overview-course-v101]], [[M4-synthesis-overview-course-v101]]
- **Previous Checkpoint**: [[M2-to-M3-transition-reflection-course-v101]]
- **Next Synthesis**: [[portfolio-cover-letter-prompt-course-v101]]
