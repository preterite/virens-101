...
Position 3 in the QUANTITATION sequence. Scenes G1, V4.

The Acer nexus makes three claims that require sourcing. They form a syllogism, and the genealogy runs Marx → Olson → Edwards, with each link adding specificity.

---

## Claim 1: Technology Defined as Capital-for-Labor Substitution

**Core formulation:** Technology substitutes capital (or capital-intensive processes) for labor (or labor-intensive processes).
...
**Status:** ✅ Source identified. ⬜ Page number needed from physical copy.

---

## Claim 2: Writing as Technology in the Economic Sense
...
## Claim 3: Economic Inquiry as Intrinsic to Composition

**Core formulation:** If writing is a technology, and technologies substitute capital for labor, and that substitution is economic, then composition is a necessary site and subject of economic inquiry — not borrowing economic metaphors but engaging in actual economic analysis.

**Source:** Edwards (2014), same passage cited above.

**What this claim does in the Acer nexus:** It performs the legitimacy move. Composition scholars who engage economic questions are not importing a foreign disciplinary lens; they are investigating dynamics already present in their object of study. This reframes the entire webtext's relationship to economics: the twelve principles are not "economic metaphors for writing" but economic analyses of writing processes that were already economic.

**Supporting context:** The 2012 _JAC_ special issue on economies of writing (34.3-4) demonstrates field-level interest in economic questions but, as Edwards (2014) argues, largely without engagement with economic scholarship. The webtext's economic vocabulary (labor, capital, appropriation, circulation, fixed/liquid capital) draws on the tradition Edwards identifies as missing: Gibson-Graham, Resnick and Wolff, Horner's materialist critique.

**Status:** ✅ Source identified. Argument is self-citational by design — this is Edwards's contribution.
...
| Role | Source | Status |
|------|--------|--------|
| Definition of technology | Olson (1987) via Marx | ✅ identified, ⬜ page # |
| Extension to writing | Edwards (2014) | ✅ ready |
| Legitimacy move | Edwards (2014) | ✅ ready |
| Supporting: labor/capital frame | Horner (2000) | ✅ in foundational sources |
| Supporting: diverse economies | Gibson-Graham (2006) | ✅ in foundational sources |
| Scene grounding: G1 tech stack | Course documentation | ✅ available |
| Scene grounding: V4 design reflection | To draft | ⬜ pending |

---

## Notes

The Olson recovery resolves the "cliché without a cite" problem identified in session. The genealogy Marx → Olson → Edwards is itself argumentatively productive: it shows capital-for-labor substitution traveling from industrial economics through critical pedagogy to composition, accumulating specificity at each step. This travel narrative could appear in the nexus page prose rather than being buried in a footnote.

The self-citation carrying Claims 2 and 3 is not a weakness but a feature: the webtext extends an argument Edwards (2014) established, and the extension consists of enacting through course design what the earlier article argued theoretically. The Acer nexus is where the webtext explicitly names its relationship to prior work.
