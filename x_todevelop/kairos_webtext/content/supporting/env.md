...
# ˘ env {title="set interpretive environment"}
...
Determining decomposition's character requires that we make it the subject of Cicero's question: _cui bono_? The trajectory from Smith to Babbage to Beecher to Bain served institutional efficiency: instructor replaceability, throughput maximization, administrative legibility. The decomposed operations made it easier to staff, schedule, and assess writing instruction—not easier to write.
...
Does making student-serving decomposition visible fully escape the history it learns from? We are not certain that it does. The same operations that give students leverage can be appropriated for institutional assessment. The six-moves vocabulary is a rearrangement away from a six-point rubric. Fragment counts can become compliance metrics. Accumulation tracking can become surveillance.
