...
The answer requires three distinctions.

### ˘ cat {title="what histories have obscured"}

The historical trajectory's characteristic move is submersion. In composition's history, economic operations enter the classroom without announcing it. Bain's modes presented themselves not as technologies for organizing instructional labor but as natural features of written language. The credit hour did not register as a mechanism for commensurating heterogeneous temporal experiences but as neutral measure.

VIRENS 101 attempts to reverse this circumstance. The course names its operations as economic in character: writing _as_ labor, fragments _as_ capital, accumulation _as_ value formation. Students encounter this vocabulary not as description of some essence of writing but as a framework imposed for specific purposes, available for interrogation. The naturalization of Bain's modes forecloses possibilities. A student who understands "capture" as a requested operation can ask _why this operation, why now, who benefits_.

### ˘ pipe {title="who benefits from decomposition"}

Who profits from decomposition determines its character. The Smith-Babbage-Beecher-Bain trajectory served institutional efficiency: instructor replaceability, throughput maximization, administrative legibility. The decomposed operations made it easier to staff, schedule, and assess writing instruction—not easier to write. (insert footnote about Fred Kemp's appropriative cycle of TA deskilling)

The operations named in VIRENS 101 serve the practitioner. When a student learns to distinguish capturing from classifying, she gains leverage over a process previously experienced as undifferentiated effort. The accumulated fragments are _her_ capital, compounding across a semester into a corpus she can draw on, reorganize, and extend. The institution cannot efficiently assess whether a student's routing decisions were sound, or whether her distillation preserved what mattered: these judgments require the kind of situated expertise that resists bureaucratic capture. A simple formulation suggests decomposition serves the writer more than it serves the spreadsheet—yet this webtext argues such formulations obscure the complexity of technologizing writing.

### ˘ endif {title="where decomposition must stop"}

Babbage pointed out that the line between "requires skill" and "can be delegated to a cheaper worker" is movable. Any operation that seems irreducibly complex can, with sufficient analysis, be broken down further. His intellectual descendants in composition — the rubric, the five-paragraph theme, the Fred Kemp system — pushed decomposition without a principled stopping point.

VIRENS 101 identifies one. The course distinguishes between operations that can be decomposed and delegated (routing, classification, formatting, templating) and labor whose value is constituted in the temporal encounter itself. Reading a difficult text across time. Writing through confusion to partial clarity. Sitting with a peer's draft long enough to see what it's trying to become. These are experience goods: their value is destroyed by externalization, by any attempt to extract the encounter from the person having it. One can decompose the _preparation_ for such encounters — that is what the six operations largely perform — but one cannot decompose the encounter without destroying what makes it valuable.
...
Does making student-serving decomposition visible fully escape the history it learns from? We are not confident that it does. The same operations that give students leverage can be appropriated for institutional assessment. The six-moves vocabulary is a rearrangement away from a six-point rubric. Fragment counts can become compliance metrics. Accumulation tracking can become surveillance.

What may prevent those problems is not only the design but the ongoing practice of denaturalization: the insistence that these operations are _imposed_ technologies, not natural features of writing, and that their beneficiary must be continuously interrogated. Grant Miles, the student whose experience threads through this webtext, voices this concern. We do not resolve it. Denaturalization is a practice.

What follows is the environment these variables produce, structured in three layers that do not collapse into one.
...
- [x] Move 3: Distinguish two modes of "countable" (practitioner vs institution) ✓
- [x] Move 4: Acknowledge the risk (no false resolution) ✓
- [x] Move 5: Three-layer structure (experience/claims/evidence) ✓ (2026-02-12)
